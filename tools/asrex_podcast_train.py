...
TXT_DIR = Path(
    "/home/acg17145sv/experiments/0162_dialogue_model/J-CHAT/transcripts/podcast_train"
)
ALN_DIR = Path(
    "/home/acg17145sv/experiments/0162_dialogue_model/J-CHAT/text/podcast_train"
)
...
if __name__ == "__main__":
    ...
    wav_all = [w for w in wav_all if not is_done(w)]
    print(f"{len(wav_all)} files remain to process.")
