...
SUBDIR = "podcast_other"

IN_ROOT = Path(
    f"/home/acg17145sv/experiments/0162_dialogue_model/J-CHAT/audio/{SUBDIR}"
)
SEP_DIR = Path(
    f"/home/acg17145sv/experiments/0162_dialogue_model/J-CHAT/separated/{SUBDIR}"
)
TXT_DIR = Path(
    f"/home/acg17145sv/experiments/0162_dialogue_model/J-CHAT/transcripts/{SUBDIR}"
)
ALN_DIR = Path(f"/home/acg17145sv/experiments/0162_dialogue_model/J-CHAT/text/{SUBDIR}")
...
def worker(device: str, wav_paths: list[Path]) -> None:
    ...
    log_path = f"align_errors_{device}_{SUBDIR}.log"
