...
TXT_DIR = Path(
    "/home/acg17145sv/experiments/0162_dialogue_model/J-CHAT/transcripts_by_espnet/youtube_train"
)
ALN_DIR = Path(
    "/home/acg17145sv/experiments/0162_dialogue_model/J-CHAT/text_by_espnet/youtube_train"
)
...
def worker(
    ...
    log_path = Path(f"align_errors_{device[-1]}_espnet_youtube_train.log")
